...
public class ioread {
		...
		/**
		 * Method for generating the girl data
		 * @throws IOException
		 */
		 ...
		 */
			...
			/**
			 * Method for generating the Gift data
			 * @throws IOException
			 */
		...
		/**
		 * Method for allocation of the gifts
		 * @throws IOException
		 */
		...
		/**
		 * Method for breaking up a couple
		 * @throws IOException
		 */
		...
		/**
		 * Method for finding a boyfriend 
		 * @throws IOException
		 */
