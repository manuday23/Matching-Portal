...
public class ioread {
		...
		/**
		 * Method for generating the boys data
		 * @throws IOException
		 */
		...
		/**
		 * Method for scanning the boys data
		...
		/**
		 * Method for scanning the girls data 
		 * @throws FileNotFoundException
		 */
				...
				if(f==0)
				{
					for(j=0;j<n;j++)
					{
						...
						
						{
							...
							{
								if((b[j].getBudget() >= g[i].getMbudget() )&& (b[j].isCoupled() == false)&&(g[i].isCoupled() == false))
								{
									b[j].setCoupled(true);
									g[i].setCoupled(true);
									...
									bw.write("Coupling              "+  g[i].getName()+" Got Committed to "+ b[j].getName()+ "        "+timestamp1);
									bw.newLine();
									id++;
									a2 =1;
									t++;
		...
		/**
		 * Method for calculating  Compatibilities of the couples
		 */
		...
		/**
		 * Method for writing the happiness of the couples into the file
		 * @throws IOException
		 */
		...
		/**
		 * Method for writing the compatibilities into the file
		 * @throws IOException
		 */
		...
		/** 
		 * writing the gift details into the file
		 * @throws IOException
		 */
