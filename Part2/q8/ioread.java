...
public class ioread {
		...
		/**
		 * Method for the allocation of gifts to the couples
		 * @throws IOException
		 */
		public void GiftAllocation() throws IOException
		{
			...
			Allocation_2 al2 = new Allocation_2();
			al2.allocation(c, id, gft);
		}
	
		/**
		 * Method for calculating the happiness for all couples 
		 */
		...
		/**
		 * Method for calculating the compatibility of couples
		 */
		...
		/**
		 * Method to write the Happiness into the file
		 * @throws IOException
		 */
		...
		/**
		 * Method to write the compatibilities of couples into the file
		 * @throws IOException
		 */
		...
		/**
		 * Method to write the given gifts into the file
		 * @throws IOException
		 */
